...
<p align="center">
  <img src="architecture_diagrams/airbnb_planner_multiagent.png" />
</p> 
...
<p align="center">
  <img src="architecture_diagrams/screenshot.png" />
</p> 
...
- "Tell me about the weather in LA, CA"  
...
Important: The sample code provided is for demonstration purposes and illustrates the mechanics of the Agent-to-Agent (A2A) protocol. When building production applications, it is critical to treat any agent operating outside your direct control as a potentially untrusted entity.
